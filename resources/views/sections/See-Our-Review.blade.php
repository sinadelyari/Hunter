<section class="bg-white pt-10 pb-8 relative text-[#1b1c57]">
  <div class="w-full mx-auto">
    ...
    <div class="swiper swiper-review w-full relative overflow-visible px-4">
      <div class="swiper-wrapper">
        <!-- هر اسلاید -->
        <div class="swiper-slide  relative">
          <img src="{{ Vite::asset('resources/images/Rectangle 21 (1).png') }}" alt="hero image" class="w-full h-full md:rounded-bl-3xl" />
            ...
            <div class="flex items-center justify-between gap-4 md:mt-6">
              ...
              <div class="flex items-center">
                <div class="flex items-center gap-1">
                  <svg fill="#f59e0b" viewBox="0 0 24 24" class="w-5 h-5"><path d="M12 .587l3.668 7.429L24 9.75l-6 5.848L19.335 24 12 20.092 4.665 24 6 15.598 0 9.75l8.332-1.734z"/></svg>
                  <span>4.6</span>
                </div>
              </div>
            </div>
  ...
  <!-- پجینیشن -->
  <div class="swiper-pagination absolute top-full left-1/2"></div>
</section>
